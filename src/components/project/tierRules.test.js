...
describe("validateTiers", () => {
  ...
  // A level above the contribution cap is unreachable by construction, since a person
  // contributes once and at most the cap. The sentence is pinned because the backend
